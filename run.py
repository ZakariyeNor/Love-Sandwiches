...
def get_sales_data():
    """
    Get sales figures input from the user. Run a while loop to collect a valid string of data from the user via 
    the terminal, which must be a string of 6 numbers separated by commas. The loop will repeatedly request data, untol it is valid.
    """
    while True:
...
def  calculate_surplus_data(sales_row):
    ...
    - Positive surplus indicates easte 
    ...
    """
    Use zip method to iterate to list at a same time in a one loop
    """
...
main()
sales_colums = get_last_5_entries_sales(columns)